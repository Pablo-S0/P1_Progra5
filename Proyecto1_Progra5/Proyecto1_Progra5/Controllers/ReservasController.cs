    ...
    public class ReservasController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id)
        {
            return _context.Reservas != null ?
                        ...
                        Problem("Entity set 'AppDbContext.Reservas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaReserva,FechaFinalPago,Monto")] Reserva reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaReserva,FechaFinalPago,Monto")] Reserva reserva)
        {
            if (id != reserva.Id)
            {
                return NotFound();
